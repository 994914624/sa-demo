...
//            MyApplication.mcontext.startActivity(intent1);
            ...
            JSONObject properties = new JSONObject();
            // 获取消息标题，并保存在事件属性 msg_title 中
            properties.put("msg_title_jg", bundle.getString(JPushInterface.EXTRA_NOTIFICATION_TITLE));
            // 获取消息 ID，并保存在事件属性 msg_id 中
            ...
            Toast.makeText(context, "用户点击打开了消息\n" +
                            ...
                            "事件属性:{ msg_title_jg : " + bundle.getString(JPushInterface.EXTRA_NOTIFICATION_TITLE) +
